...
function breadcrumbLabel(location: string) {
  ...
  if (location.startsWith("/operacoes-em-massa")) return "OPERAÇÕES EM MASSA";
      ...
      <header className="sticky top-0 z-50 border-b border-border/60 bg-background/80 backdrop-blur-xl">
        <div className="container">
          <div className="flex items-center justify-between h-16 gap-4">
            ...
            <nav className="hidden md:flex items-center gap-1 min-w-0 overflow-x-auto">{visibleNavItems.map((item) => renderNavItem(item))}</nav>
