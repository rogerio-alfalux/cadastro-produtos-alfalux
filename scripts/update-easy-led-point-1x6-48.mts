/**
 * Copia as configurações do produto EASY LED POINT 1x6 48° para todos os produtos
 ...
 * - Ótica primária: LENTE OTICA 30X30MM 1 PONTO 48° - DK-25-ZJ-BK-48DEG (qtd 1)
...
const OTICA_PRIMARIA = "LENTE OTICA 30X30MM 1 PONTO 48° - DK-25-ZJ-BK-48DEG";
...
async function main() {
  ...
  const [rows] = await conn.execute(
    "SELECT id, sku, produto, otica, oticaExtra, holder, holderNaoAplicavel, dissipador, dissipadorNaoAplicavel, moduloLed2700, moduloLed3000, moduloLed4000, moduloLed5000 FROM products WHERE produto LIKE '%EASY LED POINT%1x6%48%' ORDER BY id"
  ) as any[];
